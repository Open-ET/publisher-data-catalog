local id = 'projects/openet/assets/ensemble/conus/gridmet/monthly/v2_1_pre2000';
local subdir = 'OpenET';
local version = '2.1';
...
local collection_v2_1 = importstr 'collection_v2_1_pre2000.md';
...

{
  ...
  extent: ee.extent(-126.0, 25.0, -66.0, 50.0, '1984-10-01T00:00:00Z', '1999-10-01T00:00:00Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'build_date',
