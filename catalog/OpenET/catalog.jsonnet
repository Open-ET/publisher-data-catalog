...

{
  ...
  links: [
    ...
    ee.link.child_collection('projects_openet_assets_reference_et_conus_gridmet_monthly_v1', base_url),
    ee.link.child_collection('projects_openet_assets_reference_et_conus_gridmet_daily_v1', base_url),
