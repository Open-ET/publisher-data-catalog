local id = 'projects/openet/assets/disalexi/conus/gridmet/monthly/v2_0';
local predecessor_id = 'OpenET/DISALEXI/CONUS/GRIDMET/MONTHLY/v2_0';
local successor_id = 'projects/openet/assets/disalexi/conus/gridmet/monthly/v2_1';
...
{
  id: id,
  title: 'OpenET DisALEXI Monthly Evapotranspiration v' + version + ' [deprecated]',
  version: version,
  ...
  extent: ee.extent(-126, 25, -86, 50, '2001-01-01T00:00:00Z', '2025-01-01T00:00:00Z'),
  summaries: {
    'gee:schema': [
      {
        name: 'build_date',
